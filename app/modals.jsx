...
const LoginModal = ({ appUsers, onLogin, onClose, t = (k) => k }) => {
    ...
    const [failedAttempts, setFailedAttempts] = useState(() => {
        try { return parseInt(sessionStorage.getItem('plannerLoginFails') || '0', 10) || 0; }
        catch(e) { return 0; }
    });
    const [lockUntil, setLockUntil] = useState(() => {
        try { return parseInt(sessionStorage.getItem('plannerLoginLockUntil') || '0', 10) || 0; }
        catch(e) { return 0; }
    });
    ...
    const handleLogin = async () => {
        ...
        if (!ok) {
            ...
            try { sessionStorage.setItem('plannerLoginFails', String(next)); } catch(e) {}
