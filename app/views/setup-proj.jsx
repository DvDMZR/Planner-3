    ...
    const { setActiveTab, setEmployees, setProjects, setAssignments,
        ...
        const TableHead = ({ cat }) => (
            <thead className="bg-slate-50 border-b border-slate-200">
                <tr>
                    <SortTh cat={cat} col="name"    label={t('proj.colName')}/>
                    <SortTh cat={cat} col="type"    label="Typ"       className="w-28"/>
                    <SortTh cat={cat} col="size"    label="Size"      className="w-16"/>
                    <SortTh cat={cat} col="country" label={t('proj.colCountry')} className="w-14"/>
                    <SortTh cat={cat} col="status"  label={t('proj.colStatus')}  className="w-32"/>
                    <SortTh cat={cat} col="period"  label={t('proj.colPeriod')}  className="w-44"/>
